...
export function Button2({ textOnButton, Icon }) {
  return (
    <>
      <button className="h-12 w-48 rounded-4xl m-auto bg-gray-100">
...
export function Button3({ textOnButton }) {
  return (
    <div className="">
      <button className="bg-white text-black px-4 py-2 rounded-xl font-medium hover:bg-gray-100 transition">
        {textOnButton}
      </button>
    </div>
  );
