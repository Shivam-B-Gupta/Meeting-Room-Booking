...
import employeeModel from "../db/models/employee.js"; // Adjust path as necessary
const JWT_EMPLOYEE_PASSWORD = process.env.JWT_EMPLOYEE_PASSWORD;

const employeeRoutes = Router();

employeeRoutes.post("/signup", async function (req, res) {
...
employeeRoutes.post("/signin", async function (req, res) {
